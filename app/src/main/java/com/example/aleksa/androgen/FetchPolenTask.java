...
public class FetchPolenTask extends AsyncTask<Void, Void, Void>{
    ...
    protected Void doInBackground(Void... params) {
        ...
        // String from which we later extract the data
        String polenJsonStr;

        try{

            // Strings that serve for building the query
            final String POLEN_BASE_URL = "http://data.sepa.gov.rs/api/action/datastore/search.json?";
            final String RESOURCE_PARAM = "resource_id";

            // Resource IDs for different tables
            final String RESOURCE_POLEN = "d291f9c7-b1a4-4c97-9618-c545a22fb23d";
